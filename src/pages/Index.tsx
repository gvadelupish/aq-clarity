...
const testimonials = [
  { quote: "Maria challenges assumptions I didn't know I was making, surfaces blind spots I'd learned to ignore, and asks the kind of things that stay with you long after the session ends. The best leaders I know invest in people who don't think like them. Maria is that investment for me, and one of the most valuable ones I've made.", name: "Alberto NOP", title: "Country Manager, Viatris" },
