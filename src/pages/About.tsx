      ...
      <div className="container-narrow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <FadeUp delay={0.2}>
            <div className="space-y-6 text-warm-grey leading-relaxed">
              <div>
                <p className="font-display text-foreground leading-tight text-4xl md:text-5xl mb-3">
                  Hi! I'm Maria
                </p>
                <p className="text-warm-grey leading-relaxed">An ICF ACC Certified Executive Coach.</p>
              </div>
        ...
        <FadeUp>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            <div className="bg-surface border border-surface-border w-full h-56 flex items-center justify-center p-4">
              <img src={certIcf} alt="ICF Associate Certified Coach certificate for Maria Belitskaya" loading="lazy" className="w-full h-full object-contain" />
            </div>
            <div className="bg-surface border border-surface-border w-full h-56 flex items-center justify-center p-4">
              <img src={certCec} alt="Center for Executive Coaching certificate for Maria Belitskaya" loading="lazy" className="w-full h-full object-contain" />
            </div>
            <div className="bg-surface border border-surface-border w-full h-56 flex items-center justify-center p-4">
              <img src={certEqi} alt="EQ-i 2.0 and EQ 360 Certification for Maria Belitskaya" loading="lazy" className="w-full h-full object-contain" />
            </div>
            <div className="bg-surface border border-surface-border w-full h-56 flex items-center justify-center p-4">
              <img src={certLeading} alt="Mischief Makers Leading Groups Facilitation certificate for Maria Belitskaya" loading="lazy" className="w-full h-full object-contain" />
            </div>
          </div>
        </FadeUp>
